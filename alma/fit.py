...
class Fit(object):
    ...
    def load_vis(self, uv_file, reweight=True):
        ...
        self.init_image_properties()


    def init_image_properties(self):
        '''Get image pixel scale and size.'''
        self.nxy, self.dxy = gd.get_image_size(self.u, self.v, verbose=True)
    ...
    def mcmc(self, nwalk=16, nsteps=10, nthreads=1, burn=5):
        ...
        np.savez_compressed(model_name+'/chains-'+model_name+'.npz',
